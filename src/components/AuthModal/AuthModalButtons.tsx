...
interface IAuthModalButtons {
  onFormType: () => void;
}

const AuthModalButtons: FC<IAuthModalButtons> = ({ onFormType }) => {
  return (
    <div className="flex flex-col gap-3">
      ...
      >
        ...
        <div className="font-medium text-center">По почте</div>
      </div>
      ...
      <div className="grid grid-cols-3 shadow-sm hover:shadow-md duration-300 rounded-lg border border-gray-100 cursor-pointer p-3">
        ...
        <div className="font-medium text-center">ВКонтакте</div>
      </div>
